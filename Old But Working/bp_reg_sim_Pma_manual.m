...
function f = bp_reg_sim_Pma_manual(t,x,x_p,pars,pars_min,tchange,SSdata)
...
%         f(29) = V_b - ( 4.5479 * SF + 2.4312 * SF / (1 + exp(-(V_ecf - 18.1128 * SF) * (0.4744 / SF) )) - t/100*SF );
%     elseif strcmp(change, 'increase')
%         f(29) = V_b - ( 4.5479 * SF + 2.4312 * SF / (1 + exp(-(V_ecf - 18.1128 * SF) * (0.4744 / SF) )) + t/100*SF );
%     end
% elseif t > tchange 
%     if     strcmp(change, 'decrease')
%         f(29) = V_b - ( 4.5479 * SF + 2.4312 * SF / (1 + exp(-(V_ecf - 18.1128 * SF) * (0.4744 / SF) )) - tchange/100*SF );
%     elseif strcmp(change, 'increase')
%         f(29) = V_b - ( 4.5479 * SF + 2.4312 * SF / (1 + exp(-(V_ecf - 18.1128 * SF) * (0.4744 / SF) )) + tchange/100*SF );
%     end
% end
...
% if     t <= tchange
%     if     strcmp(change, 'decrease')
%         f(40) = R_tp - ( R_a + R_bv - t/10/SF);
%     elseif strcmp(change, 'increase')
%         f(40) = R_tp - ( R_a + R_bv + t/10/SF);
%     end
% elseif t > tchange 
%     if     strcmp(change, 'decrease')
%         f(40) = R_tp - ( R_a + R_bv - tchange/10/SF);
%     elseif strcmp(change, 'increase')
%         f(40) = R_tp - ( R_a + R_bv + tchange/10/SF);
%     end
% end
...
f(50) = Phi_twreab - ( 0.025 * SF - 0.001 * SF / (mu_al * mu_adh) + 0.8 * Phi_gfilt + 0.05*tanh(5*(mu_Na-1)) * Phi_gfilt );
% mu_al - rat
