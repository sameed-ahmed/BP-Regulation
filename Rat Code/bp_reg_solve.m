...
function f = bp_reg_solve(t,x,x_p,pars,SSdata_input, ...
                          drugs,scenario,experiment)
...
Sigma_myo     = x(88); Sigma_myo_p     = x_p(88); %v
