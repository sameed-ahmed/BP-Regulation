...
sigmamyo_a = 0.7;
sigmamyo_d = 0.05;
sigmamyo_c = 1 / (exp(-sigmamyo_d * (130 - fixed_var_pars(9))));
sigmamyo_b = (1-sigmamyo_a) * (1+sigmamyo_c);
f(88) = Sigma_myo - ( sigmamyo_a + sigmamyo_b / ( 1 + sigmamyo_c * exp(-sigmamyo_d * (P_ma - fixed_var_pars(9))) ) );
% Psi_AT1RAA
