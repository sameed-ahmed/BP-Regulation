...
function f = bp_reg_solve_Nrsna(t,x,x_p,pars)
...
% eta_cdsodreab
f(23) = eta_cdsodreab - ( min(eta_etacd * lambda_dt * lambda_anp, 1) );
...
% Sigma_myo
f(78) = Sigma_myo - ( 0.348582347120430 + 5.914000532919649 / ( 1 + 8.078661756826412 * exp(-1.105825269473267 * (P_gh - 62)) ) );
% Psi_AT1RAA
