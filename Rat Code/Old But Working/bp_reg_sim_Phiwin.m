...
function f = bp_reg_sim_Phiwin(t,x,x_p,pars,Phi_win_input,tchange,fact)

%% Retrieve parameters by name.

if     t < tchange
    Phi_win_input = Phi_win_input;
elseif t >= tchange
    Phi_win_input = fact * Phi_win_input;
end
