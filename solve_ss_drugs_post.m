...
% Parameters
load_data_name_pars = sprintf(  '%s_male_pars_scenario_Pri_Hyp_bs_rep1000OLD.mat', species{spe_ind});
load(load_data_name_pars, 'pars_rep');
num_pars = size(pars_rep,1);
pars_hyp_m = pars_rep(pars_ind,:);
load_data_name_pars = sprintf('%s_female_pars_scenario_Pri_Hyp_bs_rep1000OLD.mat', species{spe_ind});
load(load_data_name_pars, 'pars_rep');
num_pars = size(pars_rep,1);
