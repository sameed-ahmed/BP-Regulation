...
% Input
% scenario: 
% lower_per:  lower change in renal perfusion pressure from baseline in mmHg 
% upper_per:  upper change in renal perfusion pressure from baseline in mmHg 
% inc_per: renal perfusion pressure increment
...
% Last scenario is with having both no myo and no TGF.
% If statement is needed to have last scenario add in both optional parameters.
if sce_ind == num_scen
